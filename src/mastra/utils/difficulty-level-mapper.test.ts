...
describe('difficulty-level-mapper', () => {
    ...
    describe('mapPhishingDifficultyToTrainingLevel', () => {
        ...
        it('should be inverse of mapTrainingLevelToPhishingDifficulty', () => {
            expect(mapPhishingDifficultyToTrainingLevel(
                mapTrainingLevelToPhishingDifficulty('beginner')
            )).toBe('Beginner');
            expect(mapPhishingDifficultyToTrainingLevel(
                mapTrainingLevelToPhishingDifficulty('intermediate')
            )).toBe('Intermediate');
            expect(mapPhishingDifficultyToTrainingLevel(
                mapTrainingLevelToPhishingDifficulty('advanced')
            )).toBe('Advanced');
        });
