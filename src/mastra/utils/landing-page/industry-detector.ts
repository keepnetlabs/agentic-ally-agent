...
const INDUSTRY_DESIGN_MAP: Record<string, Omit<IndustryDesign, 'industry'>> = {
  'Banking & Finance': {
    ...
    get logoExample() {
      return `https://img.logo.dev/jpmorganchase.com?token=${getLogoDevToken()}&size=96`;
    },
  ...
  Technology: {
    ...
    get logoExample() {
      return `https://img.logo.dev/google.com?token=${getLogoDevToken()}&size=96`;
    },
    keywords:
      /\b(tech|software|cloud|digital|app|platform|google|microsoft|apple|amazon|meta|developer|api|code|saas)\b/i,
  },
  Healthcare: {
    colors: {
      primary: '#059669',
    ...
    get logoExample() {
      return `https://img.logo.dev/mayoclinic.org?token=${getLogoDevToken()}&size=96`;
    },
  ...
  'E-commerce': {
    ...
    get logoExample() {
      return `https://img.logo.dev/amazon.com?token=${getLogoDevToken()}&size=96`;
    },
  ...
  Corporate: {
    ...
    get logoExample() {
      return `https://img.logo.dev/accenture.com?token=${getLogoDevToken()}&size=96`;
    },
  ...
  Education: {
    ...
    get logoExample() {
      return `https://img.logo.dev/coursera.org?token=${getLogoDevToken()}&size=96`;
    },
  ...
  'Media & Entertainment': {
    ...
    get logoExample() {
      return `https://img.logo.dev/netflix.com?token=${getLogoDevToken()}&size=96`;
    },
  ...
  Government: {
    ...
    get logoExample() {
      return `https://img.logo.dev/usa.gov?token=${getLogoDevToken()}&size=96`;
    },
  ...
  'Real Estate': {
    ...
    get logoExample() {
      return `https://img.logo.dev/zillow.com?token=${getLogoDevToken()}&size=96`;
    },
  ...
  'Hospitality & Travel': {
    ...
    get logoExample() {
      return `https://img.logo.dev/booking.com?token=${getLogoDevToken()}&size=96`;
    },
  ...
  'Logistics & Delivery': {
    ...
    get logoExample() {
      return `https://img.logo.dev/dhl.com?token=${getLogoDevToken()}&size=96`;
    },
  ...
  'Social Media': {
    ...
    get logoExample() {
      return `https://img.logo.dev/linkedin.com?token=${getLogoDevToken()}&size=96`;
    },
  ...
  'HR & Recruiting': {
    ...
    get logoExample() {
      return `https://img.logo.dev/workday.com?token=${getLogoDevToken()}&size=96`;
    },
  ...
  'Utilities & Energy': {
    ...
    get logoExample() {
      return `https://img.logo.dev/britishgas.co.uk?token=${getLogoDevToken()}&size=96`;
    },
  ...
  Telecommunications: {
    ...
    get logoExample() {
      return `https://img.logo.dev/t-mobile.com?token=${getLogoDevToken()}&size=96`;
    },
    keywords:
      /\b(telecom|internet|mobile|phone|cellular|data plan|fiber|broadband|wifi|5g|4g|sim card|carrier|roaming)\b/i,
  },
};
