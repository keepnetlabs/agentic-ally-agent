...
export const DEFAULT_GENERIC_LOGO =
  'https://imagedelivery.net/KxWh-mxPGDbsqJB3c5_fmA/761ba07b-5af5-443c-95b6-9499596afd00/public';
    ...
    if (!isValid) {
      ...
      matchesForUrl.forEach(({ fullTag }) => {
        ...
        const responsiveStyle =
          'max-width: 200px; max-height: 100px; width: auto; height: auto; object-fit: contain; margin: 0 auto; display: block;';
