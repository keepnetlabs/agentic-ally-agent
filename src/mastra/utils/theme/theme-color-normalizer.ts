...
function applyBrandPreset(input: string): ThemeBgClass | null {
    ...
    const brandPresets: Array<{ match: (s: string) => boolean; color: ThemeBgClass }> = [
        ...
        { match: s => s.includes('google') || s.includes('gmail') || s.includes('workspace'), color: 'bg-gradient-light-blue' },
        { match: s => s.includes('apple') || s.includes('icloud'), color: 'bg-gradient-gray' },
        { match: s => s.includes('meta') || s.includes('facebook') || s.includes('instagram'), color: 'bg-gradient-indigo' },
        ...
        { match: s => s.includes('atlassian') || s.includes('jira') || s.includes('confluence'), color: 'bg-gradient-indigo' },
        ...
        { match: s => s.includes('rapid7') || s.includes('insightvm') || s.includes('insight idr'), color: 'bg-gradient-amber' },
