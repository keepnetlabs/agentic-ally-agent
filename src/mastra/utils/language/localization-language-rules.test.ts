...
import { normLang, getLanguagePrompt, buildGlossaryPrompt, buildSystemPrompt } from './localization-language-rules';
...
describe('localization-language-rules', () => {
  ...
  describe('buildGlossaryPrompt', () => {
    ...
    it('should number glossary entries', () => {
      const glossary = [{ term1: 'translation1' }, { term2: 'translation2' }] as Record<string, string>[];
      const prompt = buildGlossaryPrompt(glossary);
