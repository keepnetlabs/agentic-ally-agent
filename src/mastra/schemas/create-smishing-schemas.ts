...
export const createSmishingInputSchema = z.object({
  ...
  targetProfile: z
    ...
    .optional(),
  difficulty: z.enum(SMISHING.DIFFICULTY_LEVELS).optional().default(SMISHING.DEFAULT_DIFFICULTY),
  ...
  includeSms: z.boolean().optional().default(true).describe('Whether to generate SMS message templates'),
  additionalContext: z
    .string()
    .optional()
...
export type CreateSmishingInput = z.output<typeof createSmishingInputSchema>;
export const createSmishingStepInputSchema = createSmishingInputSchema as z.ZodType<CreateSmishingInput>;
...
export const createSmishingOutputSchema = z.object({
  ...
  landingPage: z
    .object({
      ...
      method: z.enum(SMISHING.ATTACK_METHODS).optional(),
