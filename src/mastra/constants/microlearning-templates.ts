export const ETHICAL_POLICY = {
  ...
  purpose:
    'To transparently demonstrate that our microlearning training content fully complies with internationally recognized standards for ethical, inclusive, and positive language.',
  ...
  conclusion: ['Ethical (ISO 26000)', 'Inclusive (UN & ISO 30415)', 'Clear & Accessible (Plain Language & WCAG)'],
};
...
export const SCIENTIFIC_EVIDENCE = {
  overview: {
    ...
    description:
      'This training is grounded in evidence-based learning science, behavioral psychology, and cybersecurity research.',
  ...
  learning_theories: {
    cognitive_load_theory: {
      ...
      application:
        'Content is designed to minimize cognitive load through chunking, clear structure, and progressive complexity.',
...
export const getScene4Metadata = (
  duration: number,
  scene4Type: 'code_review' | 'actionable_content' | 'vishing_simulation' | 'smishing_simulation'
) => {
  if (scene4Type === 'code_review') {
    return {
      ...
      scientific_basis:
        'Code Review – Active Analysis + Secure Coding: Encourages critical thinking and secure design review habits.',
      icon: {
