...
describe('detectAndResolveBrand', () => {
  ...
  it('should resolve internal brand request when whitelabel config is present', async () => {
    ...
    const result = await detectAndResolveBrand('Use our company logo', mockModel, mockWhitelabelConfig);
  ...
  it('should handle unrecognized brand gracefully', async () => {
    ...
    const result = await detectAndResolveBrand('Some unknown brand', mockModel, mockWhitelabelConfig);
  ...
  it('should handle errors gracefully and return empty Context', async () => {
    ...
    const result = await detectAndResolveBrand('Instruction', mockModel, mockWhitelabelConfig);
