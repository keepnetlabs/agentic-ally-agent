/**
 * Scene Generators - 8-scene microlearning content generation
 */

export { generateScene1Prompt } from './scene1-intro-generator';
export { generateScene2Prompt } from './scene2-goal-generator';
export { generateVideoPrompt } from './scene3-video-generator';
...
export { generateScene8Prompt } from './scene8-summary-generator';
