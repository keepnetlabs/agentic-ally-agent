...

{
  "4": {
    ...
    "callerName": "Fictional male caller display name aligned with the scenario and ${analysis.language} locale (no real people).",
    "callerNumber": "Fictional caller phone number in ${analysis.language} locale format (safe, non-realistic, no real numbers).",
