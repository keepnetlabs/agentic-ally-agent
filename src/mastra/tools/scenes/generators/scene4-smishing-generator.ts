...

{
  "4": {
    ...
    "firstMessage": "First SMS line (final text, not instructions). 1-2 sentences, realistic sender intro aligned with ${analysis.topic} and the persona. CRITICAL: Sender must introduce themselves by the exact name from the senderName field above. Include a reason for the message and mild urgency, but keep details fictional and safe; do not request real data. Keep it SMS-style, short. End with a short question.",
