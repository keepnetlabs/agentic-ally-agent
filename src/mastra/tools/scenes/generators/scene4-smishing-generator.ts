...

{
  "4": {
    ...
    "senderName": "Fictional sender display name aligned with the scenario and ${analysis.language} locale (no real people).",
    "senderNumber": "Fictional sender phone number in ${analysis.language} locale format (safe, non-realistic, no real numbers).",
    ...
    "firstMessage": "First SMS line (final text, not instructions). 1-2 sentences, realistic sender intro aligned with ${analysis.topic} and the persona. Include a reason for the message and mild urgency, but keep details fictional and safe; do not request real data. Keep it SMS-style, short. End with a short question.",
