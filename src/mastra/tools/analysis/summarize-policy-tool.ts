...
const summarizePolicySchema = z.object({
  question: z.string().min(1, 'Question about company policy is required'),
  focusArea: z.string().optional().describe('Optional focus area (e.g., "phishing", "password", "data protection")'),
  language: z.string().optional().default('en').describe('Target language for summary (BCP-47 code)'),
