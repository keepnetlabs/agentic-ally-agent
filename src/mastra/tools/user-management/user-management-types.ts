...
export const GET_ALL_PAYLOAD = {
  ...
  filter: {
    ...
    FilterGroups: [{ Condition: 'AND', FilterItems: [], FilterGroups: [] }],
  },
...
export const getUserInfoOutputSchema = z.object({
  ...
  userInfo: z
    .object({
      ...
      preferredLanguage: z
        ...
        .optional()
        .describe(
          'User preferred language (e.g., "English (United Kingdom)", "Arabic (Saudi Arabia)", "Turkish (Turkey)")'
        ),
    })
    .optional(),
  recentActivities: z
  ...
  analysisReport: z
    .any()
    .optional()
    .describe('The structured executive report JSON generated by AI analysis (can be partial).'),
...
// Partial interface matching AnalysisSchema structure but with optional fields
