...
export async function rewriteScene4Actionable(scene: any, context: RewriteContext): Promise<any> {
    ...
    const systemPrompt = `You are a ${targetLanguage} cybersecurity trainer creating action steps FROM SCRATCH.
...
3. Think like a native ${targetLanguage} business communicator
...
- Rewrite all text naturally - practical and clear
